...
ALLERGEN_MAP = {
    ...
    "knoflook": {
        ...
        "alt_map": {
            "knoflook":          "Mespuntje Asafoetida (duivelsdrek) of knoflookolie (gezeefd, stukjes verwijderd)",
            "knoflookteen":      "Mespuntje Asafoetida of knoflookolie (gezeefd)",
            "knoflooktenen":     "Mespuntje Asafoetida of knoflookolie (gezeefd)",
            "knoflookpoeder":    "Mespuntje Asafoetida of bieslookpoeder",
            "geperste knoflook": "Mespuntje Asafoetida of knoflookolie (gezeefd, stukjes verwijderd)",
        },
        "exceptions": [],
    },
