...
_VLEES = [
    ...
    "kipreepje", "kipreepjes",
    "kipschotel",
    "kipshoarma", "kipshawarma",
    "kipwrap",
    "kipburger", "kipburgertje",
    "kipsoep",
    "kippenbouillon",
    "kippenpastei",
    "kipkebab", "kip kebab",
    "kiptandoori", "kip tandoori",
    "kipmasala", "kip masala",
    "kiptikka", "kip tikka",
    "kippencurry", "kip curry",
    # Kalkoen
...
def _compile_mapping(mapping: dict) -> dict:
    ...
    # Patroon 1: exact woordgrens aan beide kanten (huidige aanpak, geen valse positieven)
    pattern = re.compile(
