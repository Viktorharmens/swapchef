...
ALLERGEN_MAP = {
    "lactose": {
        "triggers": ["melk", "room", "boter", "kaas", "kwark", "yoghurt", "slagroom",
                     "crème fraîche", "creme fraiche", "mascarpone", "mozzarella",
                     "parmezaan", "parmesan", "ricotta", "ghee"],
        "alt": "Haver- of soja-alternatief",
        "exceptions": ["kokosmelk", "amandelmelk", "havermelk", "sojamelk",
                       "rijstmelk", "kokosroom", "kokosboter"],
    },
    "gluten": {
